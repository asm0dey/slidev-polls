...
/**
 * Presenter-login source of truth. Backed by the {@code admin_user} table — the Argon2id hash
 * stored there is compared by Spring Security's {@code Argon2PasswordEncoder} wired in {@link
 * SecurityConfig}, so per-install salts validate against the same literal password.
 *
