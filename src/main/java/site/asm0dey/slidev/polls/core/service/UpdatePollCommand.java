...
/**
 * Patch-style command for {@link PollService#updateForOwner}. Any field may be {@code null} to
 * leave it unchanged. {@code questions} — when non-null — replaces the full question list (per
 * OpenAPI {@code UpdatePollRequest}). {@code allowedOrigins} — when non-null — replaces the origins
