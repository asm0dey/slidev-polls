...
class VoteTest {
  ...
  void carriesArrayOfOptionIds() {
    ...
    Vote v = new Vote(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(),
                      List.of(a, b), "voter-1", Instant.now());
  ...
  void emptyOptionIdsAllowed() {
    Vote v = new Vote(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(),
                      List.of(), "voter-abstain", Instant.now());
