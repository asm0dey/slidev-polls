...
/**
 * Deck-token self-inspection endpoint used by the Slidev addon's in-deck auth control to validate
 * a freshly-pasted token and to re-validate on page reload (feature 002, FR-003, FR-005).
 *
 ...
 * bearer never gets here — the filter leaves the context anonymous and
 * {@code ProblemAuthenticationEntryPoint} emits {@code DECK_TOKEN_INVALID}. The endpoint is
